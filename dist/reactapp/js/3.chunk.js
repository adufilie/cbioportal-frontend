...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CCbioportalFrontendNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
	    filename: 'C:/cbioportal-frontend/src/pages/datasetView/DatasetPage.jsx',
	                ...
	                var _ret = function () {
	                    ...
	                    _this2.props.datasets.forEach(function (item) {
	                        if (studies.indexOf(item.cancer_study_identifier) === -1) {
	                            ...
	                            tempObj = {
	                                CancerStudy: [React.createElement('a', { key: 'name', href: 'http://www.cbioportal.org/study?id=' + item.cancer_study_identifier + '#summary', target: '_blank' }, item.name), React.createElement('a', { key: 'icon', href: 'https://github.com/cBioPortal/datahub/blob/master/public/' + item.cancer_study_identifier + '.tar.gz', download: true }, React.createElement('i', { 'class': 'fa fa-download' }))]
	                            };
	                            if (!_.isNull(item.citation)) {
	                                tempObj.Reference = React.createElement('a', { target: '_blank', href: 'https://www.ncbi.nlm.nih.gov/pubmed/' + item.pmid }, item.citation);
	                            }
	                            rows.push(tempObj);
	                        }
